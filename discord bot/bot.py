...
# --- CONFIG ---
SPREADSHEET_ID = "1cmIducUliwGzy94Bx8l-OUrY-aDGN9bqkD0JefZSabw"
SHEET_NAME = "Sheet1"  # or whatever the tab is named
LOCATION_TAGS = {
    '-ieee': 'IEEE',
    '-mcgill': 'McGill',
    '-home': 'Home',
...
client.run("MTM5MTE5MzQ3OTU3NjY4MjU4Ng.GSKlnj.MM7-ujdRf2HTAT0_KAmQC5lW2CLy-mVA0jbbzU")